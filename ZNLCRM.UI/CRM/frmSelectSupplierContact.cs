...
namespace ZNLCRM.UI.CRM
{
    public partial class frmSelectSupplierContact : frmSelectForm
    {
        ...
        private void frmSelectSupplierContact_Load(object sender, EventArgs e)
        {
            BindComboBox();
            BindDataGridView();
        }
