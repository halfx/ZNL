...
namespace ZNLCRM.Controls
{
    ...
    /// 以TextBoxX做为编辑控件
    /// </summary>
    public class TextBoxXEditingControl : TextBoxX, IDataGridViewEditingControl
    {
        ...
        //{
        //    if (this.ButtonCustom.ItemReference.RenderBounds.Contains(e.X, e.Y))
        //    {
        //        this.OnButtonCustomClick(e);
        //    }
        //    else
        //    {
        //        base.OnMouseUp(e);
