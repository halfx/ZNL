...
namespace ZNLCRM.Controls
{
    ...
    public class SummaryControlContainer : Control
    {
        ...
        private UcDataGridViewSummary dgv;
        ...
        public SummaryControlContainer(UcDataGridViewSummary dgv)
        {
            if (dgv == null)
        ...
        protected bool IsInteger(object o)
        {
            ...
            if (o is string)
            {
                ...
                Int32 i32;
                Int16 i16;
                if (Int64.TryParse(o.ToString(), out i64))
                    return true;
                if (Int32.TryParse(o.ToString(), out i32))
                    return true;
                if (Int16.TryParse(o.ToString(), out i16))
                    return true;
            }
            return false;
        }
        ...
        protected bool IsDecimal(object o)
        {
            ...
            if (o is string)
            {
                ...
                if (Decimal.TryParse(o.ToString(), out dec))
                    return true;
                if (Single.TryParse(o.ToString(), out sgl))
                    return true;
        ...
        private void reCreateSumBoxes()
        {
            ...
            foreach (DataGridViewColumn dgvColumn in sortedColumns)
            {
                ...
                sumBox.Top = 0;
                sumBox.Height = initialHeight + 3;//dgv.RowTemplate.Height;
            ...
            {
                sumRowHeaderLabel.Font = new Font(new System.Drawing.Font("宋体", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134))), dgv.SumRowHeaderTextBold ? FontStyle.Bold : FontStyle.Regular);
                sumRowHeaderLabel.Anchor = AnchorStyles.Left;
                sumRowHeaderLabel.TextAlign = ContentAlignment.MiddleLeft;
                sumRowHeaderLabel.Height = initialHeight + 3;//sumRowHeaderLabel.Font.Height;
                ...
                sumRowHeaderLabel.BackColor = Color.FromArgb(0xa9, 0xc4, 0xe9);
